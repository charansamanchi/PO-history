		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PO history overview",
									"targetURL": "#managedtest1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"managedtest1-display": {
								"semanticObject": "managedtest1",
								"action": "display",
								"description": "PO history overview",
								"title": "PO history overview",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=managedtest1",
									"url": sap.ui.require.toUrl("managedtest1")
								}
							}
						}
					}
